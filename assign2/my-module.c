...
{
    printk(KERN_INFO "LOADING my-module, which was written by Daniel Avery\n");
    return 0;	// Non-zero return means that the module couldn't be loaded.
}

static void __exit my_module_cleanup(void)
{
    printk(KERN_INFO "UNLOADING my-module, which was written by Daniel Avery\n");
}
